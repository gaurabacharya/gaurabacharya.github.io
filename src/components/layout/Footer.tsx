...
export default function Footer() {
  return (
    <footer className="snap-end bg-ink px-5 sm:px-10 lg:px-[56px] pb-[40px] pt-[48px] lg:pt-[64px]">
      ...
      <div className="mx-auto mt-[44px] flex max-w-[1240px] flex-col justify-between gap-[16px] sm:flex-row sm:flex-wrap sm:gap-[24px] border-t border-cream/[0.14] pt-[22px] font-mono text-[10.5px] uppercase tracking-[0.08em] text-cream/50">
